...
An opinionated development workflow that enforces good engineering practices. Triggers automatically when you start any dev work.
...
```
/plugin install superdev@ne-claude-plugins
```
